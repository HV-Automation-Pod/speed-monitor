  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Configure thresholds and view triggered alerts</p>
      </div>

      {/* Section 1: Create Alert Rule */}
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <h2 className="text-base font-semibold text-gray-900 mb-4">Create Alert Rule</h2>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        {rules.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center px-4">
            <p className="text-sm font-medium text-gray-500 mb-1">No alert rules configured yet</p>
            <p className="text-xs text-gray-400">Create a rule above to start receiving alerts</p>
          </div>
        ) : (
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-0.5">Last 50 triggers</p>
        </div>

        {initialHistory.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center px-4">
            <p className="text-sm font-medium text-gray-500 mb-1">No alerts triggered yet</p>
            <p className="text-xs text-gray-400">Alert history will appear here when thresholds are breached</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
